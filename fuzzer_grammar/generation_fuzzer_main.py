...
def generation_fuzzer(ksy_file):
    output_directory = 'testcases'
    os.makedirs(output_directory, exist_ok=True)
    # Specify the path to your YAML file
    #file_path = '/Users/darshanadask/main_project/Fuzzer_20_12/ksy_files/padt.ksy'
    ...
    #filename = f"{id}.{file_extension}" if file_extension else f"{id}"
    #filepath = os.path.join(output_directory, filename)
    generated_file_path= write_leaf_values_to_file(data_tree, output_directory)
